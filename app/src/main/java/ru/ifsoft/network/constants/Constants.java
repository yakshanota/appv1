...
public interface Constants {
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIB";

    public static final String WEB_SITE = "http://yakshanota.com/";  //web site url address
